...
public class completeClass
    ...
    private final editorGraphics g;
    ...
    public completeClass(editorGraphics g, ArrayList<String> al) {
        //Set the keywords
        words = al;
        kw = new keywords();
    ...
    public void insertUpdate(DocumentEvent e) {
        ...
        //Auto complete will start after two characters are typed
        if (pos - start < 2) {
            return;
        }

        //Search for a match on the word being typed in the keywords ArrayList
